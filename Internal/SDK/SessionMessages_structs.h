...
{
	unsigned char                                      UnknownData_HIWT[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_B5HN[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FSessionServiceLog
{
	...
	unsigned char                                      UnknownData_5RLU[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FSessionServicePong
{
	...
	unsigned char                                      UnknownData_5VCY[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WNBW[0x7];                                     // 0x0089(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2H74[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
