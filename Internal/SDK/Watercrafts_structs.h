...
struct FScrapeableDamageSpeedEntry
{
	...
	unsigned char                                      UnknownData_BEZX[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FWatercraftRolloverCorrector
{
	...
	unsigned char                                      UnknownData_XGTA[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FRowboatDamageEffectData
{
	...
	unsigned char                                      UnknownData_6PQT[0xC];                                     // 0x000C(0x000C) MISSED OFFSET (PADDING)
...
struct FOar
{
	...
	unsigned char                                      UnknownData_ZR0O[0x28];                                    // 0x0038(0x0028) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YE4V[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LKNO[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WOIB[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FRowboatMountStateTelemetryEvent
{
	...
	unsigned char                                      UnknownData_JHVC[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FWatercraftDespawnTelemetryEvent
{
	...
	unsigned char                                      UnknownData_8K6C[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
