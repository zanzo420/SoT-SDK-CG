...
struct FFolderTotals
{
	...
	unsigned char                                      UnknownData_76W6[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAssetAuditConstantEntry
{
	...
	unsigned char                                      UnknownData_TGSE[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FCollectionLimits
{
	...
	unsigned char                                      UnknownData_9XS6[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O8B8[0x2];                                     // 0x0032(0x0002) MISSED OFFSET (PADDING)
