...
struct FVolcanoTargetChances
{
	...
	unsigned char                                      UnknownData_PFQB[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0G8T[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FWeightedVolcanoProjectile
{
	...
	unsigned char                                      UnknownData_U0Q4[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F7Y2[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FVolcanoStateData
{
	...
	unsigned char                                      UnknownData_W4I2[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FVolcanoTarget
{
	...
	unsigned char                                      UnknownData_HWWH[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HPJM[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FVolcanoTargetCoolDown
{
	...
	unsigned char                                      UnknownData_9BZX[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FVolcanoSetupDataEmbersEntry
{
	...
	unsigned char                                      UnknownData_FJTM[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
