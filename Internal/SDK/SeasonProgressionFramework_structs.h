...
struct FSeasonRewardEarnedEvent
{
	...
	unsigned char                                      UnknownData_E4GY[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelCompletionEvent
{
	...
	unsigned char                                      UnknownData_GAHS[0x2];                                     // 0x0022(0x0002) MISSED OFFSET (PADDING)
...
struct FSeasonGoalCompletionEvent
{
	...
	unsigned char                                      UnknownData_HT6M[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSeasonGoalProgressionEvent
{
	...
	unsigned char                                      UnknownData_KOF9[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTrackedObjectiveProgressUpdateMessage
{
	...
	unsigned char                                      UnknownData_0C2L[0x4];                                     // 0x00D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_0VE5[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
