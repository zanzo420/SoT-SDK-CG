...
struct FClueDestinationToTextIndex
{
	...
	unsigned char                                      UnknownData_QV63[0x4];                                     // 0x0008(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FClueDestinationChoice
{
	...
	unsigned char                                      UnknownData_NSAZ[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
...
struct FGenderSpecificTextPairings
{
	...
	unsigned char                                      UnknownData_Y6QP[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       FeminineClueDestinationDescription;                        // 0x0038(0x0018) ELEMENT_SIZE_MISMATCH (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_WGT2[0x20];                                    // 0x0038(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FTextEntryWithLayout
{
	...
	unsigned char                                      UnknownData_X2PW[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FMapRadialIconData
{
	...
	unsigned char                                      UnknownData_EC0J[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FExistingNPCToPhasedNPC
{
	...
	unsigned char                                      UnknownData_OPIH[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_TMX6[0x4];                                     // 0x0020(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
