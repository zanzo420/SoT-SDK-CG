...
{
public:
	unsigned char                                      UnknownData_LE4H[0x20];                                    // 0x0068(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_7FEX[0x20];                                    // 0x0068(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_4V4J[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_WJS4[0x30];                                    // 0x0078(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OUJK[0x48];                                    // 0x0068(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_K4PJ[0x40];                                    // 0x0068(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_0GJQ[0x30];                                    // 0x0068(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_963E[0x8];                                     // 0x0068(0x0008) MISSED OFFSET (PADDING)
