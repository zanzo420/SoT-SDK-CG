...
{
	unsigned char                                      UnknownData_FQ55[0x40];                                    // 0x0000(0x0040) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1RFG[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FResetStateMachineRpc
{
	...
	unsigned char                                      UnknownData_DOTM[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_D60K[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FNDC[0x18];                                    // 0x0018(0x0018) MISSED OFFSET (PADDING)
...
struct FTestActionStateSerialisableData : public FActionStateSerialisableData
{
	...
	unsigned char                                      UnknownData_BESF[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FActionStatePriorityRelationship
{
	...
	unsigned char                                      UnknownData_BCME[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_H2JA[0xA0];                                    // 0x0000(0x00A0) MISSED OFFSET (PADDING)
...
struct FActionStateConstructionInfo
{
	...
	unsigned char                                      UnknownData_B16V[0x18];                                    // 0x0010(0x0018) MISSED OFFSET (PADDING)
...
struct FInnerTestStruct
{
	...
	unsigned char                                      UnknownData_1QOC[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTestActionStateConstructionInfo : public FActionStateConstructionInfo
{
	...
	unsigned char                                      UnknownData_N9D6[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FTestActionStateConstructionInfoWithInner : public FActionStateConstructionInfo
{
	...
	unsigned char                                      UnknownData_MN4Z[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_YI0O[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_7VKO[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9K57[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2FTJ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FTestActionStateMessage : public FActionStateMessage
{
	...
	unsigned char                                      UnknownData_KAMD[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FTestActorActionStateConstructionInfo : public FActorActionStateConstructionInfo
{
	...
	unsigned char                                      UnknownData_7Q3V[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
