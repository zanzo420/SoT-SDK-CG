...
struct FWieldableMysteriousNoteLayoutItem
{
	...
	unsigned char                                      UnknownData_YQPZ[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
struct FMysteriousNoteInfo
{
	...
	unsigned char                                      UnknownData_A531[0x2];                                     // 0x0012(0x0002) MISSED OFFSET (PADDING)
...
struct FClientNoteData
{
	...
	unsigned char                                      UnknownData_VE15[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_JZ9F[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventTriggerMysteriousNotesPopup
{
	...
	unsigned char                                      UnknownData_2MYT[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_BKVU[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_H8UP[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_G5SO[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LJ2B[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FPlayerMysteriousNoteItem
{
	...
	unsigned char                                      UnknownData_30CD[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
