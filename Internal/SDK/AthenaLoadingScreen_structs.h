...
{
	unsigned char                                      UnknownData_YO5F[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JU83[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_O7QD[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
