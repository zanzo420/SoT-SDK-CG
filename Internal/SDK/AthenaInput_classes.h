...
{
public:
	unsigned char                                      UnknownData_N05W[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PADJ[0xB0];                                    // 0x0028(0x00B0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6Y6X[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_HWZX[0x58];                                    // 0x0030(0x0058) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_QJ6T[0x50];                                    // 0x0028(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_J745[0x8];                                     // 0x00D8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DN5V[0x8];                                     // 0x05C8(0x0008) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_NNFO[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
