...
struct FPirateDescription
{
	...
	unsigned char                                      UnknownData_2JGD[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VS4T[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FRadialCoordinate                           BodyShapeCoordinate;                                       // 0x000C(0x0008) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData_VBPW[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IPAK[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBlendedSubMeshSpecification
{
	...
	unsigned char                                      UnknownData_IIF2[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMaterialReferenceEntry
{
	...
	unsigned char                                      UnknownData_0M1O[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_2HXK[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LSNZ[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GCE8[0x2];                                     // 0x0012(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T39B[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P7TJ[0x18];                                    // 0x0040(0x0018) MISSED OFFSET (PADDING)
...
struct FTextureSwitchGenderEntry
{
	...
	unsigned char                                      UnknownData_Z2YD[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FStringAssetReference                       Texture;                                                   // 0x0008(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
struct FTextureSwitchEthnicityEntry
{
	...
	unsigned char                                      UnknownData_DM36[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FStringAssetReference                       Texture;                                                   // 0x0008(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
struct FIPGTestClass
{
	...
	unsigned char                                      UnknownData_UQMU[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VZSZ[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FIPGBlendingMethod
{
	...
	unsigned char                                      UnknownData_HYIQ[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FIPGSetGroup
{
	...
	unsigned char                                      UnknownData_MRGL[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FIPGBlendRange
{
	...
	unsigned char                                      UnknownData_VUPZ[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FIPGSetData
{
	...
	TEnumAsByte<PirateGenerator_EIPGGender>            Gender;                                                    // 0x0008(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TEnumAsByte<PirateGenerator_EIPGEthnicity>         Ethnicity;                                                 // 0x0009(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_NPKL[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FIPGSetsData
{
	...
	unsigned char                                      UnknownData_E5ZT[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FIPGData
{
	...
	unsigned char                                      UnknownData_AZZL[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FClothingSlot
{
	...
	unsigned char                                      UnknownData_KP9H[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FClothingPart
{
	...
	unsigned char                                      UnknownData_5VQB[0x6];                                     // 0x001A(0x0006) MISSED OFFSET (PADDING)
