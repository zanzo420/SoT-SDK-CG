...
{
	unsigned char                                      UnknownData_F4V7[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RN4R[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QAM4[0x90];                                    // 0x0000(0x0090) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SLJ3[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZLXF[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_AR36[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_VLID[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FServerMigrationHeartbeatEvent
{
	...
	unsigned char                                      UnknownData_5JQZ[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LPUV[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (PADDING)
