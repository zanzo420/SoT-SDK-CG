...
struct FSeasonIconPopupAsset
{
	...
	unsigned char                                      UnknownData_12KC[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FSeasonProgressionUIEventTypeTelemetryFragment
{
	...
	unsigned char                                      UnknownData_DQCW[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FSeasonProgressionUITelemetryFragment
{
	...
	unsigned char                                      UnknownData_JUKU[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FSeasonNotificationContent
{
	...
	unsigned char                                      UnknownData_IZJD[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FNavigationDesc
{
	...
	unsigned char                                      UnknownData_M50V[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDeedProgressDesc
{
	...
	unsigned char                                      UnknownData_D224[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOpenSeasonsMenuEvent
{
	...
	unsigned char                                      UnknownData_L5BF[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGuid                                       Id;                                                        // 0x0004(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor)
...
struct FSeasonsPopupEvent
{
	...
	unsigned char                                      UnknownData_8BQY[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
struct FSeasonGoalPopupAsset
{
	...
	unsigned char                                      UnknownData_YZIV[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
...
{
	TEnumAsByte<SeasonProgressionUI_EMoreButtonSource> MoreButtonSource;                                          // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_3NEJ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
