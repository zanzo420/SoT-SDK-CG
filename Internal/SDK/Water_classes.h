...
{
public:
	unsigned char                                      UnknownData_LHH9[0x28];                                    // 0x0418(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_XC5S[0x8];                                     // 0x03D8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CORO[0x10];                                    // 0x03D0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_801Z[0x50];                                    // 0x03F8(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_8PVI[0x8];                                     // 0x0588(0x0008) Fix Super Size
	unsigned char                                      UnknownData_PZX5[0x10];                                    // 0x0590(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_JSYY[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZUXM[0x28];                                    // 0x00C8(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_3E0D[0x20];                                    // 0x0028(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CDPF[0x8];                                     // 0x05A8(0x0008) Fix Super Size
	unsigned char                                      UnknownData_I03Z[0x20];                                    // 0x05B0(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7O2D[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7TGX[0x7];                                     // 0x0109(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BSCE[0x4];                                     // 0x0124(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8OEJ[0x18];                                    // 0x0140(0x0018) MISSED OFFSET (PADDING)
