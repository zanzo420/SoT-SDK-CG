...
public:
	...
	unsigned char                                      UnknownData_ESHP[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_K3XU[0x3];                                     // 0x0409(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ESHX[0x20];                                    // 0x0420(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GASK[0x10];                                    // 0x0230(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1DEG[0x8];                                     // 0x00E0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NHEO[0x14];                                    // 0x00FC(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
