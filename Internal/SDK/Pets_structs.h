...
struct FHangoutSpotParams
{
	...
	unsigned char                                      UnknownData_8H6B[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPetDangerHearingThreat
{
	...
	unsigned char                                      UnknownData_ET6G[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPetFeedingAnimationData
{
	...
	unsigned char                                      UnknownData_AJY3[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHangoutSpotPosition
{
	...
	unsigned char                                      UnknownData_D7BO[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B5P3[0x6];                                     // 0x0042(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class APawn*                                       Occupier;                                                  // 0x0048(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_Y0GU[0x10];                                    // 0x0050(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VF7C[0x2];                                     // 0x0062(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6WR8[0xE];                                     // 0x0072(0x000E) MISSED OFFSET (PADDING)
...
struct FPetRelationship
{
	...
	unsigned char                                      UnknownData_SAZ8[0x18];                                    // 0x0008(0x0018) MISSED OFFSET (PADDING)
...
struct FReactStateMapping
{
	...
	unsigned char                                      UnknownData_G5AI[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NEN6[0x4];                                     // 0x00C4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWieldablePetDropTimeout
{
	...
	unsigned char                                      UnknownData_9UIO[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWieldablePetFoodSourceEntry
{
	...
	unsigned char                                      UnknownData_FA3W[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FWieldablePetHungerAnimationData
{
	...
	unsigned char                                      UnknownData_X252[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPetTurnToFaceData
{
	...
	unsigned char                                      UnknownData_USB9[0xC];                                     // 0x0014(0x000C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CRFT[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_IE1R[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventPetReactedToFood : public FEventPetFoodBase
{
	...
	unsigned char                                      UnknownData_T30K[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FAEK[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_82YM[0x2];                                     // 0x0000(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OH2K[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ITME[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_083B[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_44KY[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FEventWieldablePetPutOnPerch
{
	...
	unsigned char                                      UnknownData_ZHAD[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_UQYC[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventPetReactBegun
{
	...
	unsigned char                                      UnknownData_1KOH[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FPetBaseTelemetryFragment
{
	...
	unsigned char                                      UnknownData_SFA0[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWieldablePetPutOnPerchTelemetryEvent
{
	...
	uint32_t                                           HangoutSpotIndex;                                          // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_CQT0[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_3QBK[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FPetReactedToFoodTelemetryEvent
{
	...
	unsigned char                                      UnknownData_VI6F[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FPetReactedTelemetryEvent
{
	...
	unsigned char                                      UnknownData_LRAI[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZRVH[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_VK7W[0xC];                                     // 0x0000(0x000C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_V1F8[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_405C[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FPetDespawnActionStateParams
{
	...
	unsigned char                                      UnknownData_MNF7[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
struct FPetSpawnActionStateParams
{
	...
	unsigned char                                      UnknownData_L9ZC[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
