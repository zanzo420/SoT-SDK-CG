...
struct FClueSite
{
	...
	unsigned char                                      UnknownData_1L1X[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FRestrictedClueType
{
	...
	unsigned char                                      UnknownData_G74V[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FClueSiteLootRestriction
{
	...
	unsigned char                                      UnknownData_9NPW[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FWeightedDebris
{
	...
	unsigned char                                      UnknownData_NZYP[0x4];                                     // 0x0000(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	float                                              Weight;                                                    // 0x0020(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_XJOH[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FSeaClueCreationChoice
{
	...
	unsigned char                                      UnknownData_USX1[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
struct FEventClueObtained
{
	...
	unsigned char                                      UnknownData_PAWN[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
