...
struct FWindZoneParams
{
	...
	unsigned char                                      UnknownData_3P9F[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_VG4E[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_B076[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
