...
{
public:
	unsigned char                                      UnknownData_BSRR[0x18];                                    // 0x03D0(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Z5EB[0x18];                                    // 0x00C8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S80F[0x768];                                   // 0x00F0(0x0768) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WDJR[0x18];                                    // 0x0858(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_3A8W[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_VWRZ[0x10];                                    // 0x03D8(0x0010) MISSED OFFSET (PADDING)
