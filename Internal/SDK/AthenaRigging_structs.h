...
struct FRopeCatenaryDynamicsParams
{
	...
	unsigned char                                      UnknownData_22AG[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FRopeStyleParams
{
	...
	unsigned char                                      UnknownData_N0SB[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FRiggingSystemPulleyParams
{
	...
	unsigned char                                      UnknownData_CC0S[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0IKU[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FRiggingSystemLineParams
{
	...
	unsigned char                                      UnknownData_HERU[0x4];                                     // 0x0074(0x0004) MISSED OFFSET (PADDING)
